...
Autoindex::createListing(const std::string &DirectoryName) {
...
std::string Autoindex::createHTML(const std::string &DirectoryName,
                                  const std::string &RequestedPath,
                                  const std::vector<std::string> &Names) {
  std::stringstream stream;

  stream << "<html><head><title>Index of " << RequestedPath
         << "</title></head>\n"
