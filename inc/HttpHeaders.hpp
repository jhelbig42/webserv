...
public:
  ...
  typedef enum { ContentLength = (1u << 0), ContentType = (1u << 1)  } HeaderType;

  typedef enum { Unknown, TextCss, TextCsv, ImageGif, TextHtml, ImageXIcon, ImageJpeg, ApplicationJavascript, ApplicationJson, ImagePng, ApplicationPdf, ImageSvgXml, TextPlain } MediaType;
